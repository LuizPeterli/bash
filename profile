...
# Dist upgrade
alias dpg='sudo apt-get dist-upgrade -y'
...
# Alias restart SSH
alias ssh='sudo vim /etc/ssh/sshd'
alias sshstatus='sudo service ssh status'
alias rldssh='sudo service ssh restart'

# Alias restart Samba
alias samba='sudo vim /etc/samba/smb.conf'
alias smbstatus='sudo service samba status'
alias rldsmb='sudo service samba restart && service snmb restart && service nmbd restart'
